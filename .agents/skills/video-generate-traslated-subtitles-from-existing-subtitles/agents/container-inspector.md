...
- When the selected MKV has no subtitle streams, report: "No se encontraron subtítulos incrustados en el archivo original, por lo que este flujo no puede traducirlo a español. Cuando quieras crear subtítulos desde el audio del video, usa la skill `video-generate-new-subtitles-from-audio`, que estará orientada a transcribir las voces y generar un MKV con subtítulos base para un flujo posterior de traducción."
