...
- Verify the final MKV is the only file at the root of `output/<stem>/` and generated ASS/SRT helpers exist only under `debug/video-generate-traslated-subtitles-from-existing-subtitles/subtitles/generated/`.
