...
- Parse `src/video-subtitle-agentic-transcription/transcribe_video_audio.ps1`.
- Compile all Python sources under `src/shared/python/` and `src/video-subtitle-agentic-transcription/python/`.
