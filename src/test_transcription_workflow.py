...
class TranscriptionWorkflowTests(unittest.TestCase):
    def test_transcription_workspace_uses_shared_id_for_outputs(self):
        workspace = build_transcription_workspace("input/NIPPON SANGOKU.mkv", "NIPPON-SANGOKU-A1B2C3")
        ...
        self.assertIn("output/NIPPON-SANGOKU-A1B2C3/NIPPON SANGOKU.transcribed.srt", workspace["transcribed_srt"].replace("\\", "/"))
        self.assertIn("output/NIPPON-SANGOKU-A1B2C3/NIPPON SANGOKU.transcribed.mkv", workspace["transcribed_mkv"].replace("\\", "/"))
