...
class VoiceCleanerTests(unittest.TestCase):
    def test_workspace_paths_share_workspace_id(self):
        workspace = build_voice_cleaner_workspace("input/capacitacion ma.mp4", "capacitacion-ma-A1B2C3")
        self.assertEqual(workspace["workspace_id"], "capacitacion-ma-A1B2C3")
        self.assertIn("subtitle_work/capacitacion-ma-A1B2C3/voice-cleaner", workspace["work_dir"].replace("\\", "/"))
        self.assertIn("output/capacitacion-ma-A1B2C3/capacitacion ma.voice-cleaned.mkv", workspace["output_mkv"].replace("\\", "/"))
        self.assertIn("output/capacitacion-ma-A1B2C3/capacitacion ma.voice-cleaned.flac", workspace["clean_flac"].replace("\\", "/"))
