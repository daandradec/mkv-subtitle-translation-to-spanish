...
from video_toolkit.languages import UnsupportedLanguageError, get_language_profile
from video_toolkit.subtitles.text import TextCue, parse_text_subtitles
...
def language_metadata(language):
    ...
    try:
        ...
        translation_warning = (
            ...
            "video-generate-traslated-subtitles-from-existing-subtitles; el MKV transcrito es valido, "
