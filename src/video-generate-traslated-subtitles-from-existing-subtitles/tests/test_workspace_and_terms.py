...
class WorkspaceAndTermsTests(unittest.TestCase):
    def test_workspace_paths_share_same_output_name(self):
        ...
        self.assertIn("output/NIPPON SANGOKU/debug/video-generate-traslated-subtitles-from-existing-subtitles", debug_dir)
        self.assertIn("output/NIPPON SANGOKU/debug/video-generate-traslated-subtitles-from-existing-subtitles/subtitles", subtitles_dir)
        self.assertIn("output/NIPPON SANGOKU/debug/video-generate-traslated-subtitles-from-existing-subtitles/reports", reports_dir)
        self.assertIn("output/NIPPON SANGOKU/debug/video-generate-traslated-subtitles-from-existing-subtitles/translations", translations_dir)
        self.assertEqual(output_dir, "output/NIPPON SANGOKU")
        self.assertIn("output/NIPPON SANGOKU/debug/video-generate-traslated-subtitles-from-existing-subtitles/subtitles/source/NIPPON SANGOKU.source.ass", workspace["source_ass"].replace("\\", "/"))
        self.assertIn("output/NIPPON SANGOKU/debug/video-generate-traslated-subtitles-from-existing-subtitles/subtitles/generated/NIPPON SANGOKU.spa.ass", workspace["spanish_ass"].replace("\\", "/"))
        self.assertIn("output/NIPPON SANGOKU/debug/video-generate-traslated-subtitles-from-existing-subtitles/subtitles/generated/NIPPON SANGOKU.spa.srt", workspace["tv_safe_srt"].replace("\\", "/"))
        self.assertIn("output/NIPPON SANGOKU/debug/video-generate-traslated-subtitles-from-existing-subtitles/reports/spanish_normalization_report.json", workspace["normalization_report"].replace("\\", "/"))
        self.assertIn("output/NIPPON SANGOKU/debug/video-generate-traslated-subtitles-from-existing-subtitles/reports/remux_validation_report.json", workspace["remux_validation_report"].replace("\\", "/"))
