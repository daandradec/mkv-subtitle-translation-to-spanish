...
from video_subtitle_agentic_transcription.postprocess import language_metadata, postprocess_transcription
from video_subtitle_agentic_transcription.remux import (
...
from video_subtitle_agentic_transcription.workspace import build_transcription_workspace
...
class TranscriptionWorkflowTests(unittest.TestCase):
    def test_transcription_workspace_uses_deterministic_output_name(self):
        ...
        self.assertIn("output/NIPPON SANGOKU/debug/video-subtitle-agentic-transcription/audio", workspace["audio_wav"].replace("\\", "/"))
        self.assertIn(
            "output/NIPPON SANGOKU/debug/video-subtitle-agentic-transcription/postprocess/NIPPON SANGOKU.transcribed.srt",
        ...
        self.assertIn(
            "output/NIPPON SANGOKU/debug/video-subtitle-agentic-transcription/reports/remux_validation.json",
