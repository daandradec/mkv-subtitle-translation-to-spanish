...
def build_voice_cleaner_workspace(input_video, workspace_id=""):
    ...
    work_dir = subtitle_work_dir / "voice-cleaner"
    ...
    return {
        ...
        "report": str(subtitle_work_dir / "voice_cleaner_report.json"),
        "samples_dir": str(output_dir / "voice-cleaner-samples"),
    }
...
def main():
    ...
    workspace.add_argument("--workspace-id", default="")
    ...
    if args.command == "workspace":
        payload = build_voice_cleaner_workspace(args.input_video, args.workspace_id)
